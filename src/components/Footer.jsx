    ...
    <>
      <div className=" bg-img-footer py-4">
        <div className="max-w-[1200px] mx-auto px-3">
          ...
          <p className=" text-white text-sm font-normal font-['Montserrat'] flex items-center gap-1  justify-center py-5">CopyrightFT {"@"} <span className="text-white text-sm font-normal font-['Montserrat']">PLANE 2022 All right reserved</span></p>
        </div>
      </div>
    </>
  );
